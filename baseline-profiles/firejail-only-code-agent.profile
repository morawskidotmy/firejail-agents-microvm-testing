# Firejail-only baseline for AI coding workloads.
# This models the previous approach: one host Firejail layer around the agent,
# no VM boundary and no /dev/kvm exposure.

include firejail-only-code-agent.local
